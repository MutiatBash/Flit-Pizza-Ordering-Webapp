    ...
    return(
        <div className="flex lg:flex-row md:flex-col mt-10 justify-between w-full items-center py-4 px-4 lg:py-8 md:px-16 lg:px-20">
            <div className=" w-[50%] flex flex-col space-y-3 gap-3 pt-14">
                <h1 className='lg:text-6xl w-[80%] font-semibold lg:leading-[4.1rem]'>Handmade, With an Extra Pinch of <span className="text-red-600">Love</span></h1>
                <p className='w-[80%] lg:text-xl tracking-wider'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                <IconButton icon={faCartShopping} text={"ORDER NOW"} className="text-white bg-[#efb64d] rounded-full capitalize mt-2"/>
            </div>
